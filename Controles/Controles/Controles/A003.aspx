<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="A003.aspx.cs" Inherits="Controles.A003" Trace="true" %>
...
<body id="MasterBody" runat="server">
    <div>
     <form id='frmCoordonnees'  enctype="multipart/form-data" runat="server">
    <fieldset id='fsCoordonnees'>
        <legend>Saisie des informations vous concernant</legend>
        <p>
            <label for='txtNom'>
                Nom :</label>
            <input class="inputText" id="txtNom" name="txtNom" type="text" runat="server"  onserverchange="txtNom_ServerChange"/>
